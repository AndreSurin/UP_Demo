...
Функция ПолучитьПрофиль(ИмяОтправителя = "", ИспользоватьIMAP = Ложь) Экспорт
	...
	// Длинная строка 3340110@mail.ru
	Профиль.АдресСервераPOP3 = Выборка.АдресPOP3Сервера;	Профиль.ПортPOP3 = Выборка.ПортPOP3;     Профиль.ИспользоватьSSLPOP3 = Выборка.SSLPOP3; 	Профиль.Пароль = Выборка.ПарольPOP3; 	Профиль.Пользователь = Выборка.ПользовательPOP3; 	Профиль.ТолькоЗащищеннаяАутентификацияPOP3 = Выборка.ТолькоЗащищеннаяАутентификацияPOP3;
	//
	...
	//3340110@mail.ru 
	НеИспользуемаяПеременная = 5757575;
	
	//Участок кода с повторяющимеся пробелами
